  ...
  return (
    <div id="resultsScreen" className="text-center space-y-6">
      <div className="bg-stone-950 border border-stone-900 rounded-2xl p-8">
        ...
        <h2 className="text-3xl font-bold text-white mb-2">{t("resultsPanel.greatJob")}!</h2>
        <p className="text-xl text-stone-300 mb-6">
          {t("resultsPanel.yourScore")}: <span id="finalScore" className="text-blue-400 font-bold">{score}/{total} ({percentage}%)</span>
        </p>
        ...
        <div className="mb-6 text-left">
          <h3 className="text-white font-semibold mb-3">{t("resultsPanel.correct")}/{t("resultsPanel.incorrect")}/{t("resultsPanel.skipped")}:</h3>
