      ...
      <div className="text-center space-y-10 max-w-2xl relative z-10">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          ...
          >
            ...
            <span className="relative z-10">{t("page404.backToDashboard")}</span>
          </Link>
          ...
          >
            ...
            <span className="relative z-10">{t("page404.chatLink")}</span>
          </Link>
          ...
          >
            ...
            <span className="relative z-10">{t("page404.quizLink")}</span>
          </Link>
        </div>
